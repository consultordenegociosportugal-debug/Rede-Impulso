...
const PLANOS = [
  ...
  { dias: 15, valor: 16.9, label: "15 dias", destaque: "Mais escolhido" },
...
export function DestacarServicoForm({ parceiroId }: { parceiroId: string }) {
  ...
  async function handleComprar() {
    ...
    try {
      const resposta = await fetch("/api/servicos/destacar/criar-checkout", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ parceiroId, dias: selecionado }),
      });
